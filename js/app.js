    ...
    var Video = function() {
        ...
        Video.prototype.getVideoHtml = function(src, addClass, index, html5Video) {
            ...
            if (videoInfo.youtube) {
                ...
                playerParams = getVimeoURLParams(this.settings.vimeoPlayerParams, videoInfo);
        ...
        Video.prototype.appendVideos = function(el, videoParams) {
            ...
            if (this.settings.videojs && (null === (_a = this.core.galleryItems[videoParams.index].__slideVideoInfo) || void 0 === _a ? void 0 : _a.html5)) try {
        ...
        Video.prototype.loadVideoOnPosterClick = function($el, forcePlay) {
            ...
            if (!$el.hasClass("lg-video-loaded")) if (!$el.hasClass("lg-has-video")) {
                ...
                if (video) _html = "string" === typeof video ? JSON.parse(video) : video;
